            ...
            if (count === correct_tags.length) {
                ...
                showMessage({
                    ...
                    renderCustomContent: () => {
                        return (
                            <View>
                                <Text style={{ color: 'white', fontSize: 20 }}>Correct: {this.state.lesson.lesson.sentence.replace("-", " ")}</Text>
    ...
    render() {
        return (
            <View style={{ flex: 1, flexDirection: 'column', paddingHorizontal: 6 }}>
                ...
                <Text style={{ color: 'white', fontSize: 22, fontFamily: 'BalsamiqSans-Bold' }}>Match Pairs</Text>
